...
import (
	...
	account "github.com/CA22-game-creators/cookingbomb-apiserver/application/usecase/account/refresh_session_token"
...
func (m *MockInputPort) Handle(arg0 account.InputData) account.OutputData {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handle", arg0)
	ret0, _ := ret[0].(account.OutputData)
	return ret0
}
